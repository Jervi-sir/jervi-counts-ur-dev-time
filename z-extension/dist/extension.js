 ...
 */
function buildSyncPayload(username, dailyTotals, dailyTotalSeconds, languageTotals) {
    const data = [];
...
async function syncToSupabase(context, username) {
    try {
        ...
        const dailyTotals = context.globalState.get(config_1.STORAGE_KEYS.DAILY, {});
        const dailyTotalSeconds = context.globalState.get(config_1.STORAGE_KEYS.DAILY_TOTAL, {});
        const languageTotals = context.globalState.get(config_1.STORAGE_KEYS.LANGUAGE_TOTALS, {});
        // Build payload
